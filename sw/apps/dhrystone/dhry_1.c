...
#define DHRY_RUNS 10000
  ...
  printf ("Cycles per run through Dhrystone:           ");
  printf ("%llu\n",
          (unsigned long long)
          (Total_Cycles / (uint64_t) Number_Of_Runs));
